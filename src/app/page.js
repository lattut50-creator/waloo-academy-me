  ...
  return (
    <div style={{ 
      ...
      <main style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '50px 20px', textAlign: 'center' }}>
          ...
          <div className="modal-overlay" onClick={() => setSelectedCourse(null)}>
            <div className="modal-content" onClick={e => e.stopPropagation()}>
              ...
              <button style={{ width: '100%', marginTop: '20px', padding: '12px', backgroundColor: mainColor, 
                      ...
                      onClick={() => { alert(`Enrollment started for ${selectedCourse.title}! We'll contact you.`); setSelectedCourse(null); }}>
                Enroll Now
              </button>
            </div>
          </div>
        ...
        {selectedEvent && (
          <div className="modal-overlay" onClick={() => setSelectedEvent(null)}>
            <div className="modal-content" onClick={e => e.stopPropagation()}>
              ...
              {/* Event Registration Form - Using your endpoint */}
              <form action="https://formspree.io/f/xnjwyyvn" method="POST">
                ...
                />
                <button type="submit" 
                        style={{ width: '100%', marginTop: '10px', padding: '12px', backgroundColor: mainColor, 
                                 color: 'white', border: 'none', borderRadius: '10px', fontWeight: 'bold', cursor: 'pointer' }}>
            ...
            {events.map(event => (
              <div key={event.id} className="event-card">
                ...
                <button 
                  ...
                  style={{ marginTop: '15px', padding: '8px 20px', backgroundColor: mainColor, 
        ...
        <div style={{ width: '100vw', padding: '60px 20px', marginBottom: '80px', 
                      backgroundColor: darkMode ? '#2d2d2d' : '#fff', borderTop: `1px solid ${darkMode ? '#444' : '#eee'}` }}>
           <h2 style={{ color: mainColor, marginBottom: '50px', fontSize: '2.2rem' }}>What Our Students Say</h2>
           <div style={{ display: 'flex', gap: '40px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <div className="testimonial-card">
                 <p style={{ fontSize: '1.1rem', color: darkMode ? '#ccc' : '#444' }}>
                   "Waloo Academy made learning easy for me. It's truly a center of knowledge!"
                 </p>
                 <h5 style={{ marginTop: '20px', color: mainColor, fontSize: '1.1rem' }}>— Ayantu G.</h5>
              </div>
              <div className="testimonial-card">
                 <p style={{ fontSize: '1.1rem', color: darkMode ? '#ccc' : '#444' }}>
                   "Programming was hard for me, but now I write code with confidence."
                 </p>
                 <h5 style={{ marginTop: '20px', color: mainColor, fontSize: '1.1rem' }}>— Abdi K.</h5>
              </div>
              <div className="testimonial-card">
                 <p style={{ fontSize: '1.1rem', color: darkMode ? '#ccc' : '#444' }}>
                   "The Economics course helped me understand Ethiopian market perfectly!"
                 </p>
        ...
        <div id="contact" className="side-by-side-container" 
             style={{ display: 'flex', gap: '20px', justifyContent: 'center', width: '100%', 
                      maxWidth: '1000px', marginBottom: '80px', padding: '0 10px' }}>
          
          {/* Newsletter Box */}
          <div className="side-box" style={{ flex: 1, backgroundColor: '#1e293b', color: 'white', 
                                             padding: '25px', borderRadius: '20px', minWidth: '320px' }}>
            <h3 style={{ color: mainColor, marginBottom: '10px' }}>Get Latest Updates!</h3>
            <p style={{ fontSize: '0.8rem', opacity: '0.8', marginBottom: '20px' }}>
              Subscribe for new courses and offers.
            </p>
            <form action="https://formspree.io/f/mojrzzqb" method="POST">
              <input 
                ...
                style={{ width: '100%', padding: '12px', borderRadius: '25px', border: 'none', 
                         marginBottom: '15px', outline: 'none' }} 
                required
              />
              <button type="submit" 
                      style={{ width: '100%', padding: '12px', backgroundColor: mainColor, 
                               color: 'white', border: 'none', borderRadius: '25px', fontWeight: 'bold', cursor: 'pointer' }}>
                Subscribe
              </button>
            </form>
          </div>
          ...
          {/* Contact Form Box */}
          <div className="side-box" style={{ flex: 1, backgroundColor: darkMode ? '#2d2d2d' : mainColorLight, 
                                             padding: '25px', borderRadius: '20px', minWidth: '320px' }}>
      ...
      <footer style={{ backgroundColor: '#0f172a', color: 'white', padding: '40px 20px', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: '25px', marginBottom: '25px', display: 'flex', gap: '30px', justifyContent: 'center' }}>
          <a href="https://t.me/walooacademy" target="_blank" rel="noopener noreferrer" className="social-icon" 
             style={{ color: '#0088cc', textDecoration: 'none', fontSize: '1.8rem' }}>
            📱 Telegram
          </a>
          <a href="https://youtube.com/@walooacademy" target="_blank" rel="noopener noreferrer" className="social-icon" 
             style={{ color: '#ff0000', textDecoration: 'none', fontSize: '1.8rem' }}>
            📺 YouTube
          </a>
          <a href="https://facebook.com/walooacademy" target="_blank" rel="noopener noreferrer" className="social-icon" 
             style={{ color: '#1877f2', textDecoration: 'none', fontSize: '1.8rem' }}>
            👍 Facebook
          </a>
        </div>
